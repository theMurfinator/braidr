...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  removeRecentProject: (projectPath: string) => ipcRenderer.invoke(IPC_CHANNELS.REMOVE_RECENT_PROJECT, projectPath),
  deleteProject: (projectPath: string) => ipcRenderer.invoke(IPC_CHANNELS.DELETE_PROJECT, projectPath),
