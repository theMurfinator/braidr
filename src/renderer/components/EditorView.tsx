                ...
                <div className="editor-draft-scene-header">
                  ...
                  <div className="editor-draft-scene-subtitle">
                    {(() => {
                      ...
                      const wordCount = isMultiSelect ? totalWordCount : singleWordCount;
                      const parts = [char?.name, chapter?.title, `Scene ${selectedScene.sceneNumber}`, `${wordCount.toLocaleString()} words`].filter(Boolean);
          ...
          const sectionDefs: { id: string; label: string; headerExtra?: React.ReactNode; render: () => React.ReactElement | null }[] = [
            ...
            },
            {
              ...
              render: () => {
                ...
                const noteTodos = getTodosForScene(sceneTodos, selectedScene.id, charName, selectedScene.sceneNumber);
            ...
            },
            {
              ...
              render: () => {
                if (!selectedScene) return null;
                const totals = getSceneSessionTotals(sceneSessions, selectedScene.id);
                ...
                const sessions = sceneSessionsList ? sceneSessionsList(selectedScene.id) : [];
                return (
                  <>
                        ...
                        <div className="editor-manual-time-form">
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              if (totalMinsVal > 0) {
                                onAddManualTime?.(selectedScene.id, totalMinsVal);
                                setManualHours('');
                                setManualMinutes('');
