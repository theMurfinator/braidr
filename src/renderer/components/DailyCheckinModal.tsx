...
export default function DailyCheckinModal({ onSubmit, onSkip }: DailyCheckinModalProps) {
  ...
  return (
    <div className="checkin-overlay" onClick={onSkip}>
      <div className="checkin-modal daily-checkin-modal" onClick={e => e.stopPropagation()}>
